...
const PixQrCodeScanScreen = ({ navigation, route }) => {
  ...
  const handleBarCodeScanned = ({ type, data }) => {
    ...
    // Log detalhado do código QR escaneado
    console.log('==========================================');
    console.log('QR CODE ESCANEADO - TIPO:', type);
    console.log('QR CODE ESCANEADO - DADOS:', data);
    console.log('QR CODE ESCANEADO - TAMANHO:', data ? data.length : 0);
    console.log('==========================================');
    ...
    try {
      ...
      // Navegar diretamente para a tela de pagamento sem mostrar alerta
      console.log('NAVEGANDO PARA PixQrCodePayment COM CÓDIGO:', data);
      navigation.navigate('PixQrCodePayment', { pixCode: data });
    } catch (error) {
      Alert.alert(
        "Erro na leitura",
